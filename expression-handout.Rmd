...
Bioconductor comes with it's own installation procedures for software and data packages, the `BiocManager()` function. You can use it to install any bioconductor package, along with all prerequisites. For example, to install the `limma` package, we can use code like this:
